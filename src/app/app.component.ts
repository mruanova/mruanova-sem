...
export class AppComponent {
  ...
  papers = 'https://link.springer.com/chapter/10.1007/11499053_28/';
  frontEnd = 'https://en.wikipedia.org/wiki/Front-end_web_development';
  softwareEngneer = 'https://en.wikipedia.org/wiki/Software_engineering';
  ...
  teamLeade = 'https://en.wikipedia.org/wiki/Team_leader';
  ...
  demo = 'https://en.wikipedia.org/wiki/Scrum_(software_development)#Sprint_review';
